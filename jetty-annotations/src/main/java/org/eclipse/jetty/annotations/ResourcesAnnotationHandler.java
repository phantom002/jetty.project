        ...
        if (resources != null)
        {
            ...
            for (int j=0;j<resArray.length;j++)
            {
                ...
                try
                {
                    ...
                    if (!org.eclipse.jetty.plus.jndi.NamingEntryUtil.bindToENC(_wac, name, mappedName) && !org.eclipse.jetty.plus.jndi.NamingEntryUtil.bindToENC(_wac.getServer(), name, mappedName)) {
